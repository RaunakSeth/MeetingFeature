...
android {
    namespace = "com.example.meetingfeature"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.meetingfeature"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    configurations.all {
        resolutionStrategy {
            force("androidx.compose.material3:material3:1.2.0-beta01")
        }
    }
...
dependencies {
    ...
    // DATE TIME
    implementation("com.maxkeppeler.sheets-compose-dialogs:date-time:1.2.1")
    //Appwrite
